...
describe("Test clear button then values", function() {
  ...
  it("should clear name and radio value when clear is clicked", function() {
    const greetingTest = greetingFactory();
    ...
    assert.equal("please select language and fill in your name", greetingTest.getNameCount())
  })
})
