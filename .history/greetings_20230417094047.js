...
function greeting() {
  ...
  if (!checkedRadioBtnElement || !greetingVal) {
    ...
    greetIntance.callNameError() ?  errorDisplay.classList.add("message") :  greetIntance.callNameError();
    errorDisplay.innerHTML = greetIntance.getAlert()
  ...
  } else if(checkedRadioBtnElement && greetingVal && greetIntance.callNameError()) {
